...
- --encoding, -e
  - 読み書き時のエンコーディングを指定します
  - 有効値: utf8, utf8-bom, shift_jis, euc-jp, cp932, cp51932, ascii
  - 省略時は utf8 (BOMなし)
...
- OPT_ENCODING (utf8, utf8-bom, shift_jis, euc-jp, cp932, cp51932, ascii)
  - 読み書き時に使用する文字コードを指定します
  - 省略時は utf8 (BOMなし)
...
## サポートについて
基本的な使い方に関するサポートはしません。PCに関する一定の知識があればGoogleなどで調べて自己解決できるかと思います。  

### バグやエラーなど
クリティカルなレベルのバグやエラーがある場合はIssueで連絡いただければと思います。お時間を頂くかもしれませんが、可能な限り対応します。  

### 要望など
こちらもIssueなどで連絡いただければ気が向いたときに実装します。あまり期待はしないでください。  
